...
body('username').exists().trim().isLength({min: 3, max: 16}).withMessage('Must be between 3 and 16 characters long.').isAlphanumeric('en-US', {ignore: ' '}).withMessage('No special characters allowed.').custom(userWare.checkDuplicateUsername), controller.signUp)
