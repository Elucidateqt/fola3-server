...
const createBugreport = async (req, res, next) => {
    ...
    try{
        const bugreport = await Report.createBugreport(uuidv4(), req.locals.user._id, req.locals.user.useragent, req.body.route, req.body.summary, req.body.description)
        res.sendStatus(204)
