...
const PERMISSIONS = ["USERS:CREATE",  "USERS:VIEW", "USERS:UPDATE:PROFILE", "USERS:UPDATE:PASSWORD", "USERS:UPDATE:ROLES", "USERS:DELETE", "PROJECT:CREATE", "PROJECTS:VIEW", "PROJECT:MANAGE", "PROJECT:DELETE", "ROLES:CREATE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "ROLES:UPDATE", "ROLES:DELETE", "PERMISSIONS:CREATE", "PERMISSIONS:VIEW", "PERMISSIONS:UPDATE", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE", "PERMISSIONS:DELETE"]
...
const BASE_ROLES = [
    ...
    {
        "rolename": "admin",
        "permissions": ["USERS:CREATE",  "USERS:VIEW", "USERS:UPDATE:PROFILE", "USERS:UPDATE:ROLES", "USERS:DELETE", "PROJECT:CREATE", "PROJECTS:VIEW", "PROJECT:MANAGE", "PROJECT:DELETE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "PERMISSIONS:VIEW", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE"],
        "scope": 'global'
    },
    {
        "rolename": "moderator",
    ...
    },
    {
        ...
        "permissions": ["PROJECT:MANAGE", "PROJECT:DELETE", "ROLES:GRANT", "ROLES:REVOKE", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE"],
        "scope": 'project'
    },
    {
