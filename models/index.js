...
const PERMISSIONS = ["USERS:CREATE",  "USERS:VIEW", "USERS:UPDATE:PROFILE", "USERS:UPDATE:PASSWORD", "USERS:UPDATE:ROLES", "USERS:DELETE", "PROJECTS:CREATE", "PROJECTS:VIEW", "PROJECTS:MANAGE", "PROJECTS:DELETE", "ROLES:CREATE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "ROLES:UPDATE", "ROLES:DELETE", "PERMISSIONS:CREATE", "PERMISSIONS:VIEW", "PERMISSIONS:UPDATE", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE", "PERMISSIONS:DELETE"]
