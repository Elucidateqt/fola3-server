...
const PERMISSIONS = ["USERS:CREATE",  "USERS:VIEW", "USERS:UPDATE:PROFILE", "USERS:UPDATE:PASSWORD", "USERS:DELETE", "PROJECTS:CREATE", "PROJECTS:VIEW", "PROJECTS:MANAGE", "PROJECTS:DELETE", "ROLES:CREATE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "ROLES:UPDATE", "ROLES:DELETE", "PERMISSIONS:CREATE", "PERMISSIONS:VIEW", "PERMISSIONS:UPDATE", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE", "PERMISSIONS:DELETE"]
...
const BASE_ROLES = [
    ...
    {
        "rolename": "admin",
        "permissions": ["USERS:CREATE",  "USERS:VIEW", "USERS:UPDATE:PROFILE", "USERS:DELETE", "PROJECTS:CREATE", "PROJECTS:VIEW", "PROJECTS:MANAGE", "PROJECTS:DELETE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "PERMISSIONS:VIEW", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE"],
        "attainOnProjectCreation": false
    },
    {
        "rolename": "moderator",
