...
const PERMISSIONS = ["USERS:CREATE",  "USERS:VIEW", "USERS:PROFILE:UPDATE", "USERS:PASSWORD:UPDATE", "USERS:ROLES:UPDATE", "USERS:PERMISSIONBLACKLIST:MANAGE", "USERS:DELETE", "PROJECT:CREATE", "PROJECTS:VIEW", "PROJECT:MANAGE", "PROJECT:DELETE", "ROLES:CREATE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "ROLES:UPDATE", "ROLES:DELETE", "PERMISSIONS:CREATE", "PERMISSIONS:VIEW", "PERMISSIONS:UPDATE", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE", "PERMISSIONS:DELETE"]
...
const BASE_ROLES = [
    ...
    {
        "rolename": "admin",
        "permissions": ["USERS:CREATE",  "USERS:VIEW", "USERS:PROFILE:UPDATE", "USERS:PASSWORD:UPDATE", "USERS:ROLES:UPDATE", "USERS:PERMISSIONBLACKLIST:MANAGE", "USERS:DELETE", "PROJECT:CREATE", "PROJECTS:VIEW", "PROJECT:MANAGE", "PROJECT:DELETE", "ROLES:GRANT", "ROLES:REVOKE", "ROLES:VIEW", "PERMISSIONS:VIEW", "PERMISSIONS:GRANT", "PERMISSIONS:REVOKE"],
        "scope": 'global'
    },
    {
        "rolename": "moderator",
